...
function HomeAd() {
  ...
  return (
    <div className="bg-[#191919] px-6 pb-4 md:px-[8%]">
      <div
        className="bg-cover bg-center flex items-center justify-center md:justify-start text-white md:text-left text-center pb-20 h-[500px]"
      ...
      >
        <div className="flex flex-col items-center md:items-start md:w-1/2">
          ...
          <button
            ...
            className="mt-12 bg-[#d87d4a] text-white p-4 cursor-pointer hover:opacity-90"
          >
            SEE PRODUCT
          </button>
        </div>
