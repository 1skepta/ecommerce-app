...
import bigearphone from "../assets/home/desktop/image-earphones-yx1.jpg";
  ...
  return (
    <div className="flex flex-col">
      <div className="relative bg-[#d87d4a] px-6 w-5/6 rounded-xl mx-auto overflow-hidden h-[600px]">
        <div className="absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/5 w-[500px] h-[500px] bg-no-repeat bg-center bg-contain z-0 bg-[url('/src/assets/home/desktop/pattern-circles.svg')] md:top-auto md:bottom-0 md:left-[0px] md:translate-x-0 md:translate-y-0"></div>
      ...
      <div
        className="bg-cover bg-center rounded-xl w-5/6 mx-auto h-[350px] my-6 flex flex-col items-start px-6 justify-center md:pl-20"
