  ...
  return (
    <div>
      <div className="flex flex-col py-12 pt-16 ">
        <div className="flex flex-col items-center bg-[#f1f1f1] mx-auto w-5/6 rounded-xl relative mb-16">
          <img
            src={earphones}
            alt="earphone image"
        ...
        <div className="flex flex-col items-center bg-[#f1f1f1] mx-auto w-5/6 rounded-xl relative">
          <img
            src={speakers}
            alt="earphone image"
            className="w-36 h-34 -mt-10"
